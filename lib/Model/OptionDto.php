...
class OptionDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OptionDto';
     ...
     * Sets number_of_days
     *
     * @param int $number_of_days How many days to extend the due date with
     *
     * @return $this
     */
     ...
     * Sets amount
     *
     * @param int $amount The fee for extending the due date this many days. In minor units.
     *
     * @return $this
     */
