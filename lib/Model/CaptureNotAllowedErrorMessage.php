...
class CaptureNotAllowedErrorMessage implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Capture not allowed error message';
     ...
     * Sets error_messages
     *
     * @param string[] $error_messages Error messages
     *
     * @return $this
     */
     ...
     * Sets correlation_id
     *
     * @param string $correlation_id Correlation id. For searching logs.
     *
     * @return $this
     */
